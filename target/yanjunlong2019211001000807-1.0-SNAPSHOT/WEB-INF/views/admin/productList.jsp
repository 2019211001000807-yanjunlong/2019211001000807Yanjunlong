<%@ page import="com.yanjunlong.model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.yanjunlong.model.Category" %>
		...
		<div class="table-responsive col-sm-10">
			...
			<c:forEach var="p" items="${productList}">
				<tr>
					...
					<%
						com.yanjunlong.model.Product p=(com.yanjunlong.model.Product)pageContext.findAttribute("p");
